---
concept_id: docs/strategies/Strategy322sgo/evaluate_karakana_exit
language: python
okf_version: '0.2'
...
## Source
Lines 894–992 in `docs/strategies/Strategy322sgo.py`
...
| called_by | [confirm_trade_exit](/docs/strategies/Strategy322sgo/confirm_trade_exit.md) |
| called_by | [custom_exit](/docs/strategies/Strategy322sgo/custom_exit.md) |
