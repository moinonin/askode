---
concept_id: docs/strategies/Strategy322sgo/pending_reversal_side
language: python
okf_version: '0.2'
...
## Source
Lines 1248–1250 in `docs/strategies/Strategy322sgo.py`
...
| called_by | [_is_reversal_entry](/docs/strategies/Strategy322sgo/is_reversal_entry.md) |
