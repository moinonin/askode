---
concept_id: docs/strategies/Strategy322sgo/stop_loss_decay
language: python
okf_version: '0.2'
...
| `SL_0` | `Optional[float]` | `None` |

## Source
Lines 198–204 in `docs/strategies/Strategy322sgo.py`
